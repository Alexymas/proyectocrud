...
const btnuptdate = document.getElementById("btn-update");
...
function table(){
    ...
    getData(db.products, (data)=>{
        if(data){
            ...
            notfound.textContent = "No se encontro registro en la base de datos"
...
function getMsg(flag, element){
    if(flag){
        element.className += " movedown"; //note the space between the "" and movedown
